...
<div class="content">
    <div id="main-content">
        <div class="author-box">
            ...
            printf('<h3>' . __('Posts by %1$s', 'minhtam') . '</h3>', get_the_author());
            ...
            if (get_the_author_meta('user_url')) : printf(
                    __('<a href="%1$s" title="Visit to %2$s website">Visit to my website</a>', 'minhtam'),
